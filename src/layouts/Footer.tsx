        ...
        <div id="footer" className={`${isDark? "bg-[var(--dark-color)] text-[var(--light-color)]" : "bg-[var(--light-color)] bg-[var(--dark-color)]"}
            ...
            <div className="h-full w-full flex flex-col items-start justify-start">
                ...
                <div className={`${isMobile? "flex-col" : "flex-row"}
                    ...
                    <div className={`${isMobile? "flex-col-reverse" : "flex-col"}
                        ...
                        <span className={`${isDark? "text-[var(--light-color)]" : "text-[var(--dark-color)]"} 
                            ...
                            spacegrotesk text-[calc(0.6vw+0.9rem)] font-semibold`}>Follow our socials</span>
                        <div className={`${isMobile? "w-full" : ""}
                            flex flex-row items-center justify-center gap-[calc(0.4vw+0.6rem)]`}>
                            <i className='bxl bx-facebook bx-tada-hover text-[calc(0.8vw+1.4rem)] cursor-pointer primary'></i>
                            <i className='bxl bx-github bx-tada-hover text-[calc(0.8vw+1.4rem)] cursor-pointer primary'></i> 
                            <i className='bxl bx-instagram bx-tada-hover text-[calc(0.8vw+1.4rem)] cursor-pointer primary'></i>
                            <i className='bxl bx-twitter-x bx-tada-hover text-[calc(0.8vw+1.4rem)] cursor-pointer primary'></i>
                        </div>
                        <span className={`${isMobile? "w-full text-justify" : ""}
                            text-[calc(0.4vw+0.8rem)]`}>
                    ...
                    <div className="flex-1 h-full w-full gap-[calc(0.4vw+0.6rem)] p-[calc(0.4vw+0.6rem)] flex flex-col items-start justify-between">
                        <div className="flex flex-col items-start justify-start gap-[calc(0.4vw+0.6rem)] text-[calc(0.4vw+0.7rem)]">
                            <span className={`${isDark? "text-[var(--light-color)]" : "text-[var(--dark-color)]"} 
                                ${isMobile? "w-full text-center" : ""}
                                spacegrotesk text-[calc(0.6vw+0.9rem)] font-semibold`}>Subscribe to our newsletter</span>
                            ...
                            <div className="w-auto flex flex-row items-center justify-start gap-[calc(0.1vw+0.2rem)] text-[calc(0.4vw+0.8rem)] flex-wrap">
                        ...
                        <div className="w-full flex flex-row items-center justify-between">
                            <span className="cursor-pointer primary text-[calc(0.4vw+0.8rem)]">© Mad Logic Studio. All rights reserved.</span>

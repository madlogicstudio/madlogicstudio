        ...
        <div id="about" className={`${isDark? "bg-[var(--dark-color)] text-[var(--light-color)]" : "bg-[var(--light-color)] bg-[var(--dark-color)]"}
            ...
            <div className="w-[90%] flex flex-col items-start justify-start shadow-xl p-[calc(0.4vw+0.6rem)] rounded-lg">
                <div className="w-full flex flex-row items-center justify-center p-[calc(0.4vw+0.6rem)] gap-[calc(0.4vw+0.6rem)]">
                    <span className="spacegrotesk text-[calc(0.6vw+0.8rem)] font-semibold">
                        At 
                    </span>
                ...
                <div className="flex flex-row items-start justify-center p-[calc(0.4vw+0.6rem)] gap-[calc(0.4vw+0.6rem)]">
                    <span className="spacegrotesk text-[calc(0.6vw+0.8rem)] font-semibold">
                        — we turn bold ideas into powerful digital experiences. As a creative web and app development company, we specialize in crafting innovative, user-focused solutions that help businesses grow and stand out in the digital world.
                    </span>
                </div>
            </div>
            ...
            <div className={`relative ${isDark? "bg-[#000000]" : "bg-[#557BA7]"}
                ...
                <video src={Square} autoPlay muted loop className="h-full w-auto object-cover filter hue-rotate-[150deg] brightness-50 contrast-[125%] saturate-[50%] cursor-pointer"></video>
                <span className="z-3 w-full montserrat text-[calc(0.8vw+1.2rem)] text-[var(--light-color)] font-semibold 
                    absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/4 text-center cursor-pointer">we bring logic to life through inspired innovation.</span>
            </div>
